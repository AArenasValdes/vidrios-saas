...
Resumen ejecutivo para cualquier IA, consultor, analista, marketer o colaborador. No reemplaza las fuentes canónicas; dirige hacia ellas.

## Fuentes canónicas

- Reglas técnicas: `AGENTS.md`
- Índice general: `docs/README.md`
- Producto: `docs/VENTORA_GIRO_PRODUCTO_2026-07.md`
- Rutas/features/datos: `docs/agent-map/README.md`
- Pagos: `docs/billing/README.md`
- Marketing: `AGENTS_MARKETING.md` y `docs/growth-os/README.md`
