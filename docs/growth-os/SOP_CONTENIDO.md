...
- reel corto de dolor o flujo
- carrusel educativo
- story con pregunta o encuesta
- post con insight comercial
- mini demo de pantalla
...
1. portada con dolor fuerte
2. explicacion del problema
3. impacto comercial
4. forma simple de resolverlo
5. mini demo o paso a paso
6. CTA
...
- usar cuentas demo o ejemplos anonimizados
- mostrar flujos cortos, no pantallas saturadas
- priorizar mobile
- usar capturas de:
  - `solicitudes`
  - `solicitudes/canales`
  - `cotizaciones`
  - `presupuesto/[token]` con datos anonimos

## Como medir rendimiento
...
Hoy Ventora no guarda nativamente visualizaciones, respuestas sociales ni demos desde contenido.

Por eso:

- performance social vive en cada plataforma
- atribucion a Ventora vive por UTM y registro manual
- no asumir medicion automatica de contenido dentro del producto actual
