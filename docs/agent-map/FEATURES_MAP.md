...
- **Tablas Supabase**: `fabrication_recipes`, `fabrication_recipe_tests` (migracion base `20260729230407`, grants `20260730001306`, metadatos de validacion `20260730003756` y procedencia explícita `20260914120000_fabrication_recipe_provenance`). La última migración queda pendiente de aplicar/verificar en remoto. No toca tablas legacy.
