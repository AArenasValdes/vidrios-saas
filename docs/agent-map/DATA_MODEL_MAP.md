...
- **Estado**: Implementada en remoto con `20260729230407_fabrication_recipes_persistence`, grants `20260730001306_harden_fabrication_recipe_grants` y metadatos Fase 4 `20260730003756_fabrication_recipe_validation_metadata`. La migración aditiva `20260914120000_fabrication_recipe_provenance` agrega procedencia explícita y queda pendiente de aplicar/verificar en remoto. La UI guiada incorpora asistente de texto solo para producir borradores JSON.
