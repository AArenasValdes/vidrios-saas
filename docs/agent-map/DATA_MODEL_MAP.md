...
- **Evidencia P1**: `source_type='workshop'` puede representar procedencia declarada sin validar toda la receta. La evidencia por regla se conserva en `definition.observaciones` y `definition.notasValidacion`; AL-32 confirma 3201/3202 (-21 mm en hoja) y conserva 3204/3205 pendientes; AL-42 confirma 4201/4202 con -17 mm en hoja y conserva 4229 pendiente. Una receta parcial queda `review_required` o `draft`, nunca `workshop_validated` por existencia previa.
