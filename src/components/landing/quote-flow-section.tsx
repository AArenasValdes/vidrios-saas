...
const flowSteps = [
  {
    ...
    image: `${FLOW_BASE}/paso2-componentes-trim.png`,
    width: 422,
    height: 846,
  ...
  },
  {
    ...
    image: `${FLOW_BASE}/paso2-datos-trim.png`,
    width: 422,
    height: 846,
  ...
  },
  {
    ...
    image: `${FLOW_BASE}/paso3-resumen-trim.png`,
    width: 415,
    height: 853,
  ...
  },
  {
    ...
    image: `${FLOW_BASE}/pdf-listo-trim.png`,
    width: 420,
    height: 846,
    ...
    <section id="solucion" className={s.section} aria-labelledby="quote-flow-title">
      <div className={s.container}>
        <header className={s.header}>
          <p className={s.kicker}>Flujo principal</p>
