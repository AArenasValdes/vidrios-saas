...
function scaleItemPrice(
  ...
  return {
    ...
    observaciones: encodeCotizacionItemPresentationMeta({
      ...
      glassSheetWidthMm: presentation.glassSheetWidthMm,
      glassSheetHeightMm: presentation.glassSheetHeightMm,
      glassSheetCostClp: presentation.glassSheetCostClp,
      glassSheetBillingRule: presentation.glassSheetBillingRule,
      lineMermaPct: presentation.lineMermaPct,
