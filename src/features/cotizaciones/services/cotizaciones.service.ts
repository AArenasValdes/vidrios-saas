...
function mapCotizacionToWorkflowRecord(input: {
  ...
  return {
    ...
    condicionesDePago: input.cotizacion.condicionesDePago ?? undefined,
    condicionesVenta: input.cotizacion.condicionesVenta ?? undefined,
    terminosCondiciones: input.cotizacion.terminosCondiciones ?? undefined,
