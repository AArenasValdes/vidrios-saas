...
export const COUNTRY_PRESETS: Record<SupportedCountryCode, CountryPreset> = {
  ...
  MX: { countryCode: "MX", label: "México", currencyCode: "MXN", locale: "es-MX", timezone: "America/Mexico_City", phoneCountryCode: "+52", phonePlaceholder: "+52 55 1234 5678", taxLabel: "IVA", taxRateDefault: 16, taxIdLabel: "RFC", commercialRoundingIncrement: 1 },
  PE: { countryCode: "PE", label: "Perú", currencyCode: "PEN", locale: "es-PE", timezone: "America/Lima", phoneCountryCode: "+51", phonePlaceholder: "+51 912 345 678", taxLabel: "IGV", taxRateDefault: 18, taxIdLabel: "RUC", commercialRoundingIncrement: 1 },
