...
function buildNormalizedProfileInput(
  ...
  return {
    ...
    margenObjetivoDefecto: resolved.margenObjetivoDefecto,
    mermaMaterialesDefecto: resolved.mermaMaterialesDefecto,
    costoManoObraDefecto: resolved.costoManoObraDefecto,
    costoTrasladoDefecto: resolved.costoTrasladoDefecto,
    costoOtrosDefecto: resolved.costoOtrosDefecto,
...
export function resolveOrganizationProfile(
  ...
  return {
    ...
    margenObjetivoDefecto: profile?.margenObjetivoDefecto ?? null,
    mermaMaterialesDefecto: profile?.mermaMaterialesDefecto ?? null,
    costoManoObraDefecto: profile?.costoManoObraDefecto ?? null,
    costoTrasladoDefecto: profile?.costoTrasladoDefecto ?? null,
    costoOtrosDefecto: profile?.costoOtrosDefecto ?? null,
    ...
    async updateByOrganizationId(
      ...
      try {
        const persisted = await repository.upsertByOrganizationId(organizationId, {
          ...
          margenObjetivoDefecto: input.margenObjetivoDefecto,
          mermaMaterialesDefecto: input.mermaMaterialesDefecto,
          costoManoObraDefecto: input.costoManoObraDefecto,
          costoTrasladoDefecto: input.costoTrasladoDefecto,
          costoOtrosDefecto: input.costoOtrosDefecto,
