...
const MARKET_DEFINITIONS: Record<SupportedCountryCode, MercadoPagoMarketDefinition> = {
  CL: {
    ...
    providerPlanEnv: {
      quote_only_monthly: "MERCADOPAGO_CL_QUOTE_ONLY_MONTHLY_PLAN_ID",
    ...
    commercialAmounts: {
      quote_only_monthly: BILLING_PLANS.quote_only_monthly.amountClp,
...
function buildDisabledMarketDefinition(
  ...
  return {
    ...
    providerPlanEnv: {
      quote_only_monthly: `${prefix}_QUOTE_ONLY_MONTHLY_PLAN_ID`,
